...
// let Example;
// function preload(){
//   Example = loadImage("assets/Example.png"); 
// }
// function setup() {
//   createCanvas(windowWidth, windowHeight);

//   // Create a start button
//   startButton = createImg("assets/Example.png");
...
//     if (index === 0) {
//       background(255, 0, 0); // Red (change to knight like calse thing)
//     } else if (index === 1) {
//       background(0, 0, 255); // Blue (forest)
//     } else if (index === 2) {
//       background(255, 255, 0); // Yellow (ork like camp)
//     } else if (index === 3) {
//       background(169); // Gray (nice)(mines)
//     }
